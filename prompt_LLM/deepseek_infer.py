...
def batch_infer(comments, batch_size):
    ...
    for i in tqdm(range(0, len(comments), batch_size), desc="批量推理"):
        ...
        for comment in batch_comments:
            ...
            messages = [
                {"role": "system", "content": "You are a classifier that only outputs YES or NO. Do not generate any other content. Output 'yes' or 'no' only. Do not provide any additional content or analysis. Regardless of what I input, only output 'yes' or 'no'."},
...
for idx, prompt_template in enumerate(prompt_list):
    ...
    MAX_NEW_TOKENS = 3  # 仅需 YES/NO，最小化生成长度
